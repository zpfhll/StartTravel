    ...
    override fun onCreateView(
            ...
            when(it.type) {
                0 -> {
                    ...
                    if(it.state == 0){
                        ...
                        animator.duration = 0
                        animator.start()
                        travelAction.background = resources.getDrawable(R.drawable.button_background7, null)
        ...
        travelAction.setOnClickListener {
            if(it.tag.toString().equals("start")){
                val animatorFlag = ObjectAnimator.ofFloat(travelFlag,
                    "translationX",
                    Utils.instance().DPToPX(60f+34f),
                    travelFlag.translationX)
                animatorFlag.duration = 300

                val animatorDetail = ObjectAnimator.ofFloat(travelDetail,
                    "translationX",
                    -Utils.instance().DPToPX(60f+34f),
                ...
                val animatorEditAlpha = ObjectAnimator.ofFloat(travelEdit, "alpha", travelEdit.alpha, 1f)
                animatorEditAlpha.duration = 100
                val animatorFlagAlpha = ObjectAnimator.ofFloat(travelFlag, "alpha", travelFlag.alpha, 1f)
                animatorFlagAlpha.duration = 100
                val animatorDetailAlpha = ObjectAnimator.ofFloat(travelDetail, "alpha", travelDetail.alpha, 1f)
